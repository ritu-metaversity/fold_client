              ...
              <div className="card">
                ...
                <div className="card-body container-fluid container-fluid-5 ">
                  <div className="row row5">
                    ...
                    <div className="col-2">
                      <div className="form-group mb-0 mt-7">
                        <select name="reportType" className="custom-select" onChange={getBetStatus}>
                    ...
                    <div className="col-12 account-statement-tbl">
                      <div className="table-responsive">
                        <table
                          ...
                          <tbody className={ShowData?"":"d-none"}>
                            {dataList &&
                              dataList?.map((res) => {
                                return (
                                  <tr role="row" className={res?.isback === false ? "lay" : "back"}>
                                    <td
                                      role="columnheader"
                                      scope="col"
                                      aria-colindex="1"
                  ...
                  <div className={`row row5 mt-2 ${ShowData?"":"d-none"}`}>
                  <div
