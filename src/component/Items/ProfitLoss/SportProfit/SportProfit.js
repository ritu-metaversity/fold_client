      ...
      <div className="report-container statement1">
        <div className="card">
          <div className="card-body container-fluid container-fluid-5 max1_height">
                ...
                <div className="form-group mb-0">
                  <select
                    ...
                    {SportList?.length &&
                      SportList?.map((item) => {
                        return (
                          <option value={item?.sportId} key={item?.sportId}>
                            {item?.sportName}
                          </option>
                        );
                      })}
                ...
                <div className="form-group mb-0">
                  <select
                    ...
                    {SportData?.length &&
                      SportData?.map((item) => {
                        return (
                          <option value={item?.matchId} key={item?.matchId}>
                            {item?.matchName}
                          </option>
                        );
                      })}
                  ...
                  <table
                    ...
                    {isLoading ? (
                      ...
                      <>
                        <tbody
                          className={`${
                            DataList === 0 || DataVal === null ? "dis-none" : ""
                          }`}>
                          {PLValue?.length &&
                            PLValue.map((res) => {
                              return (
            ...
            <div
              className={`row row5 mt-2 ${DataVal === null ? "d-none" : ""}`}>
