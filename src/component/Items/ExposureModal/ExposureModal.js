                        ...
                        <div className="col-12">
                          <div
                            ...
                            <div
                              ...
                              <div className="custom-control custom-control-inline custom-radio">
                                  <div>
                                      <span className='betInfo'>Total Bets: <span className="betColor">{BetDetail?.totalBets}</span></span>{" "}
                                      <span className='betInfo'>Total Amount: <span className="betColor">{BetDetail?.totalStake}</span></span>
                                  </div> 
                              </div>
                            </div>
                          </div>
                    ...
                    <div className="col-12">
                      <div className="table-responsive unsetTable">
                        <table
                          ...
                          <tbody className={DataList?.length === 0 ?"dis-none":""}>
                            {DataList?.length &&
