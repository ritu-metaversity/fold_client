    ...
    <div className="report-container wrapper">
        <div className="card">
          {/* <div className="card-header">
            <p className="mb-0 heading-ch">Un-Setteled Bet</p>
            <p className="mb-0 heading-ch">Un-Setteled Bet</p>
          </div> */}
                          ...
                          <div
                            ...
                            <div className="custom-control custom-control-inline custom-radio">
                              <input
                                ...
                                onChange={(e) => setBetExpValue(e.target.value)}
                                value="1"
                                defaultChecked
                              />{" "}
                              <label
                      ...
                      <div className="col-12">
                        <div
                          ...
                          <div
                            ...
                            <div className="custom-control custom-control-inline custom-radio">
                                <div>
                                    <span className='betInfo'>Totla Bets: <span className="betColor">{BetDetail?.totalBets}</span></span>{" "}
                                    <span className='betInfo'>Totla Amount: <span className="betColor">{BetDetail?.totalStake}</span></span>
                                </div> 
                            </div>
                          </div>
                        </div>
                        ...
                        <thead className="">
                          <tr role="row" className="">
                            ...
                            <th
                              ...
                              scope="col"
                              aria-colindex="9"
                              className="text- bg-color eventName">
                              Place Date
                            </th>
                          </tr>
                        </thead>
