export const data = [
  {
    ...
    rules: [
      {
        name: "bookmaker",
        rule: `<div data-parent="#eventaccordion0" id="event0game0" class="card-body collapse show" style=""><div class="rule-text">
                                                        If the match will not take place within 48 hours of the original kick-off time bets will be void.
                                                    </div><div class="rule-text text-danger">
      ...
      {
        name: "fancy",
        rule: `<div data-parent="#eventaccordion0" id="event0game1" class="card-body collapse show" style=""><div class="rule-text text-danger">
      ...
      {
        name: "match",
        rule: `<div data-parent="#eventaccordion0" id="event0game2" class="card-body collapse show" style=""><div class="rule-text">
                                                        Match Odds :-  
...
Bets will be void if the match is abandoned. Extra-time and penalty shootouts do not count.
  ...
  },
  {
    ...
    rules: [
      {
        name: "bookmaker",
        rule: `<div data-parent="#eventaccordion8" id="event8game0" class="card-body collapse show" style=""><div class="rule-text text-danger">
      ...
      {
        name: "fancy",
        rule: `<div data-parent="#eventaccordion8" id="event8game1" class="card-body collapse show" style=""><div class="rule-text">
                                                        ...
                                                        Ex. : First match total 4's is 20 and second match over reduced so bets after first match upto second match started that all deleted and for other bets average counted total 4's is 24 and third match total 4's is 26, So Result of Total 4's is 7
                                                        ...
                                                        Most runs given by Bowler in an Inning of Tour : Maximum How much Runs conceded by a individual Bowler in an Innings. Ex : For T20I How much runs conceded by a bowler in his 4 overs Quota.

                                                    </div><div class="rule-text">
                                                        Highest total runs in individual match of IPL : Maximum Total runs of both Teams in individual match. 
                                                        ...
                                                        Top Batsman Runs in Tour : Most runs by an Individual Player in any Individual matches in ODI/T20I Format of Tour
      ...
      {
        name: "fancy1",
        rule: `<div data-parent="#eventaccordion8" id="event8game3" class="card-body collapse show" style=""><div class="rule-text text-danger">
      ...
      {
        name: "match",
        rule: `<div data-parent="#eventaccordion8" id="event8game5" class="card-body collapse show" style=""><div class="rule-text text-danger">
                                                        IPL
                                                    </div><div class="rule-text text-danger">
                                                        ...
                                                        Total 1st over runs: Average 5 runs will be given in case match abandoned or over reduced (only 1st innings valid)
                                                    </div><div class="rule-text">
                                                        Total 1st 6 over run:- Average 46 runs will be given in case match abandoned or over reduced (Only 1st Innings valid)
                                                    </div><div class="rule-text">
                                                        ...
                                                        Total Extras - Average 16 Extras will be given in case match abandoned or over reducedTotal Extras - Average 16 Extras will be given in case match abandoned or over reduced
                                                    </div><div class="rule-text">
  ...
  },
  {
    ...
    rules: [
      {
        name: "match",
        rule: `<div data-parent="#eventaccordion6" id="event6game0" class="card-body collapse show" style=""><div class="rule-text">
                                                        Match Odds :- 
If 1st set has been not completed at the time of the retirement or disqualification, then all bets
